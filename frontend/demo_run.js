window.DEMO_RUN = {
  ...
  "policies": [
    {
      ...
      "explanation": "기존 양보운전 유지. spillback 누적 1980초, 모형 내 누적 체류시간 265228 vehicle-seconds가 비교 기준선이 된다.",
      "extra": {
        "approach_p95_delay": {
          "R1_N": 1099.4,
          "R1_W": 278.3,
    ...
    },
    {
      ...
      "explanation": "고정 미터링 적용 시 무대응 대비 spillback 누적 -62.4%, 모형 내 누적 체류시간 -41.6%. 가드 위반(FAIRNESS_P95_EXCEEDED, FAIRNESS_P95_EXCEEDED)으로 적용 불가.",
      "extra": {
        "approach_p95_delay": {
          "R1_N": 259.9,
          "R1_W": 432.5,
    ...
    },
    {
      ...
      "explanation": "연속 게이팅 적용 시 무대응 대비 spillback 누적 -100.0%, 모형 내 누적 체류시간 -77.3%. 모든 안전·공정성 가드를 통과했다.",
      "extra": {
        "approach_p95_delay": {
          "R1_N": 36.1,
          "R1_W": 0.0,
  ...
  "reproducibility": {
    ...
    "git_commit_sha": "58f34532f0d79514181b0b0c12db0968c21243f8",
    ...
    "result_checksum": "1c5ee778ce55091a96615886e05df38ed3e4641eef9be537280d91425a69db5b",
    "rule_version": "rainflow-guard-v2",
    "scoring_version": "rainflow-rule-v1",
    "simulator_version": "rainflow-queue-v2",
    "source_live_run_id": "live-rain_spillback_a-s42-177b836eea",
    "source_tree_checksum": "a306f9186fd67ed4fdc7ae0980b7f3888864ee7f77f1843bc30df4348da93f74"
  },
  "result_source": "fixture",
