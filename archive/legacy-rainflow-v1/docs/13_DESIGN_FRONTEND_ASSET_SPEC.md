...
> [!CAUTION]
> **TATS 게임 UI 대체 공지 — 2026-08-04**
>
> 이 문서의 1440×900 프레임, 8px 간격, 접근성, 상태 색상과 에셋 규격은 유지한다.
> 정책 카드, 하단 KPI 카드와 운영자 승인 중심 화면 구성은 최신 TATS 게임에 적용하지 않는다.
> 지도 중심 레이아웃, 진단 오버레이, 우측 신호 편집, 알고리즘 스킬북과 개별 건물
> 업그레이드는 [`19_TATS_UI_UX_DIRECTION_V1.md`](19_TATS_UI_UX_DIRECTION_V1.md)를 따른다.
